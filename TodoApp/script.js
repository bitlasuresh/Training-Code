...
function getContainer(priority){
	if(priority == 1){
		return document.getElementById('todo-list-container1')
	} else if (priority == 2){
		return document.getElementById('todo-list-container2');
	} else if (priority == 3) {
		return document.getElementById('todo-list-container3');
	} else {
		return document.getElementById('todo-list-container4');
	}
}
